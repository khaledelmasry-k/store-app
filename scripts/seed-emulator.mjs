...
async function main() {
  ...
  await createPlan('plan-starter', 'STARTER', 499, 500, 300, 'للمتاجر التي بدأت البيع وتحتاج أدوات تسويق أساسية', ['كل مزايا Free', 'كوبونات', 'روابط بيع', 'صفحة هبوط واحدة', 'تخصيص المتجر', 'تنبيهات المخزون'], { priceYearly: 4990, trialDays: 3, launchPrice: 0, launchEnabled: false, landingPagesLimit: 1, salesLinksLimit: 10, staffLimit: 3, storageLimit: 1024, slug: 'starter', sortOrder: 1, unlimitedProducts: false, unlimitedSalesLinks: false, variantInventory: true, coupons: true, analytics: true })
  await createPlan('plan-growth', 'GROWTH', 799, 2000, 1500, 'للمتاجر النامية التي تحتاج أدوات تشغيل أوسع', ['كل مزايا Starter', 'تسعير بالكمية', 'حدود تشغيل أعلى', 'صفحات هبوط متعددة', 'روابط بيع موسعة'], { priceYearly: 7990, trialDays: 3, launchPrice: 0, launchEnabled: false, landingPagesLimit: 5, salesLinksLimit: 50, staffLimit: 10, storageLimit: 5120, slug: 'growth', isPopular: true, sortOrder: 2, unlimitedProducts: false, unlimitedSalesLinks: false, quantityPricing: true, variantInventory: true, coupons: true, analytics: true })
  ...
  await createPlan('plan-pro', 'PRO', 1299, 0, 10000, 'للمتاجر الكبيرة التي تحتاج حدوداً أعلى', ['كل مزايا Growth', 'أعلى حدود استخدام', 'منتجات غير محدودة', 'روابط بيع غير محدودة'], { priceYearly: 12990, trialDays: 3, launchPrice: 0, launchEnabled: false, landingPagesLimit: 20, salesLinksLimit: 0, staffLimit: 50, storageLimit: 20480, slug: 'pro', sortOrder: 3, unlimitedProducts: true, unlimitedSalesLinks: true, quantityPricing: true, variantInventory: true, coupons: true, analytics: true })
