          ...
          <Card title="معلومات المزود" subtitle="الهوية الأساسية التي ستظهر للمتاجر — الحقول الأساسية فقط، التفاصيل التقنية في إعدادات متقدمة">
            ...
            <details style={{ marginTop: 18, border: '1px solid var(--mka-border, #e5e7f2)', borderRadius: 12, padding: '12px 14px', background: 'var(--mka-surface-soft, #f8f9ff)' }}>
              ...
              <div className="grid grid-2" style={{ marginTop: 14 }}>
                ...
                {(draft.adapterKey === 'custom' || draft.adapterKey === 'custom-carrier-x') && (
                  <div className="shipping-secure-note" style={{ gridColumn: '1 / -1' }}>
                    <Icon name="warning" ariaHidden />
                    <span>تنبيه: "custom"/"custom-carrier-x" محول مرجعي عام وليس تكاملًا حقيقيًا مع API الشركة. لا تُفعّل "جاهز للإنتاج" إلا بعد بناء محول خاص بهذه الشركة في الكود.</span>
                  </div>
                )}
