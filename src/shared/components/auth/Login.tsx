...
export const Login: FunctionalComponent<Props> = ({ role }) => {
  ...
  const sessionExpiredNotice = role === 'merchant' && loginParams.get('session') === 'expired'
  ...
  return (
    <AuthShell>
      <div className="auth-card">
        ...
        {sessionExpiredNotice && <p className="auth-success-message" role="status">تم تحديث أمان الحساب. سجّل الدخول مرة أخرى.</p>}
